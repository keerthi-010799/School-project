            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Donation Collection Report</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">Donation Collection Report</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;Donation Collection Report </b></h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-3">
                                    <select id="partywise" class="form-control form-control select2" name="partywise">
                                        <option value=''>--Select Paymentmethod--</option>
                                        <?php
                                        $sql = mysqli_query($dbcon,"SELECT DISTINCT paymentmethod FROM `donationdetails` WHERE 1 ");
                                        while ($row = $sql->fetch_assoc()){	
                                            $paymethod=$row['paymentmethod'];
                                            echo '<option  value="'.$paymethod.'" >'.$paymethod.'</option>';
                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['partywise'])&&$_GET['partywise'])){
                                                ...
                                                $sql = "SELECT * from donationdetails p where 1=1 ";
                                                if($_GET['st']!=''){
                                                    if($st==$end){
                                                ...
                                                if(isset($_GET['partywise'])&&$_GET['partywise']!=''){
                                                    ...
                                                    //$sql.=" and p.campaigns ='".$_GET['partywise']."'";  
													$sql.=" and p.paymentmethod='".$_GET['partywise']."'";  													
                                                }

                                                $sql.=" ;"; 

                                            }else{
                                                $sql = "SELECT * from donationdetails ;";    
                                            }
...
<script>
    ...
    $(document).ready(function() {
        ...
        var printhead = party_var!=''?'<p><b>Payment Method : </b>'+party_var+'</p>':'';
        printhead+= date_range!=''?'<p><b>Date : </b>'+date_range+'</p>':'';
        var excel_printhead = party_var!=''?'Payment Method: '+party_var:'';
        excel_printhead+= '  ';
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                            '<p><img src="<?php echo $baseurl;?>assets/images/logo/logo@0,25x.png" style="width:50px;height:50px;" /></p><p class="lead text-center"><b>Sri Bhairava Nilayam <br>Donation Collection Report - Online/Offline</b><br/></p>'+printhead+'</div>'
                        );
                ...
                }, 
                {
                    ...
                    title:'Donation Collection Report', footer: true ,
    ...
    function get_po_reports(){
        ...
        location.href="collectionReport.php?st="+st+"&end="+end+"&partywise="+partywise;
