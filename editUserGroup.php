...
if(isset($_POST['userGroupEdit']))
{ 
	var_dump($_POST);
	extract($_POST);
	
    $updateUserGroup = "UPDATE `groups` SET `groupname` = '".$groupname."',`description` = '".$desc."'
										WHERE `id` =".$groupid;
	//echo $updateUser;
    if(mysqli_query($dbcon,$updateUserGroup))
    {
			...
			<div class="row">
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-6 col-lg-6 col-xl-6">						
						...
						<div class="card-header">
								...
								<h5><i class="fa fa-pencil-square-o"></i><b>&nbsp;Edit User Groups</b></h5>
								 </div>
    ...
    <!--li><a data-toggle="pill" href="#menu2">Change Password</a></li-->
							...
							<div class="modal-dialog">
								<div class="modal-content"-->
									...
									<form method="post" action="editUserGroup.php"  enctype="multipart/form-data">
											<?php
											include("database/db_conection.php");//make connection here
											if(isset($_GET['id']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM groups WHERE id=$id");
									...
									<div class="form-group col-md-8">
									  ...
									  <input type="text" name="groupname" placeholder="Members,Admin,Manager,Superadmin,Staff" required class="form-control" value="<?php echo $groupname;?>"/>
									</div>
									</div>
									...
									<div class="form-group col-md-12">
									  ...
									  <input type="text"  name="desc" placeholder="" required class="form-control" value="<?php echo $desc;?>"/>
									</div>
									</div>
									...
									<div class="modal-footer">
										...
										<button type="submit" name="userGroupEdit" value="userEdit" class="btn btn-primary">Update</button>
									</div>
									</div>
