                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;Expense Transactions History Report </b></h3>
                        </div>
                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['partywise'])&&$_GET['partywise'])){
                                                ...
                                                $sql = "SELECT * from expensenoteslog p where 1=1 ";
                                                if($_GET['st']!=''){
                                                    if($st==$end){
                                                ...
                                                $sql = "SELECT * from expensenoteslog ;";    
                                            }
...
<script>
    ...
    $(document).ready(function() {
        ...
        var printhead = party_var!=''?'<p><b>Expenses Transactions History Log Report: </b>'+party_var+'</p>':'';
        printhead+= date_range!=''?'<p><b>Date : </b>'+date_range+'</p>':'';
        var excel_printhead = party_var!=''?'Expense Transactions History Log Report : '+party_var:'';
        excel_printhead+= '  ';
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                            '<p><img src="<?php echo $baseurl;?>assets/images/logo/logo@0,25x.png" style="width:50px;height:50px;" /></p><p class="lead text-center"><b>Expenses Transactions History Log Report</b><br/></p>'+printhead+'</div>'
                        );
                ...
                }, 
                {
                    ...
                    title:'Expenses Transactions History Report', footer: true ,
    ...
    function get_po_reports(){
        ...
        location.href="expenseTransactionHistory.php?st="+st+"&end="+end+"&partywise="+partywise;
