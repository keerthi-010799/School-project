						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								<div class="card-header">
										...
										<a href="addAttendanceProfile.php" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
										Add Attendance Profile</a></span>
										...
										<tbody>
											<?php
													...
													//	$batchwise = $_GET['batchwise'];	
														...
														fathername,mobile,academic,attendance,CURDATE() AS Today 
