						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left"><i class="fa fa-calendar-o bigfonts" aria-hidden="true"></i>List Academic</h1>
									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<tbody>
											...
											<?php
													...
													$sql = "SELECT academic,description,status, id FROM academic";
													...
													echo '<td><a href="editAcademic.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
													...
													?>						
															...
															function deleteRecord_8(RecordId)
															{
																if (confirm('Confirm delete')) {
																	window.location.href = 'deleteAcademic.php?id='+RecordId;
																}
															}
													</script>
