                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel2">Route/Van Wise SMS Form</h5>
						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left">Routeno wise Van Student List</h1>
													<ol class="breadcrumb float-right">
														<li class="breadcrumb-item">Home</li>
														<li class="breadcrumb-item active">Routeno wise Van Student List</li>
													</ol>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								<div class="card-header">
									...
									<i class="" aria-hidden="">Routeno wise Van Student List</i>
								</div>
								...
								<input type="submit" class="btn btn-secondary btn-sm"  name="exportStudents" value="CSV Export"/>
                                    ...
                                    <div class="form-group col-md-2">
                                         ...
                                         <select id="inputState" data-parsley-trigger="change"  class="form-control form-control-sm"  name="routeno">
                                             <option value="">-Select Route-</option>
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here

                                                    $sql = mysqli_query($dbcon, "SELECT distinct routeno  FROM studentprofile WHERE vanflag='Y' AND status ='Y' order by routeno asc");
									...
									<table id="example1" class="table table-bordered table-hover display">
										<thead>
											<tr>
													...
													<th style="width:30px">Route/Van#</th>
													<th style="width:30px">Areaname</th>
										...
										<tbody>
											<?php
													...
													$sql = "SELECT id,image,academic,admissionno,routeno,areaname,concat(firstname,' ',lastname) as name,concat(class,' / ',section) as classsec,
													fathername,mobile,status FROM `studentprofile` WHERE vanflag = 'Y' AND status = 'Y'";
