									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<tbody>
											...
											<?php
													...
													$sql = "SELECT section,description, id FROM section";
													...
													echo '<td><a href="editSection.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
													...
													?>						
															...
															function deleteRecord_8(RecordId)
															{
																if (confirm('Confirm delete')) {
																	window.location.href = 'deleteSection.php?id='+RecordId;
																}
															}
													</script>
