                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        ...
                        <span class="pull-right">
										<a href="markAttendance.php" class="btn btn-success btn-sm"><i class="fa fa-calendar-check-o bigfonts" aria-hidden="true"></i>
                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['partywise'])&&$_GET['partywise'])){
                                                ...
                                                $sql = "SELECT p.id,p.attendance,p.academic,p.admissionno,concat(s.firstname,' ',s.lastname) as name,s.class,s.fathername,
                                                s.mobile,p.createdby,p.createdon 
                                                FROM studentsattendance p,studentprofile s
                                                WHERE p.admissionno = s.admissionno
                                                AND s.status='Y'
                                                 AND 1=1 ";
                                                if($_GET['st']!=''){
                                                    if($st==$end){
                                                ...
                                                if(isset($_GET['partywise'])&&$_GET['partywise']!=''){
                                                    ...
                                                    $sql.=" and s.class='".$_GET['partywise']."'";    
                                                }
                                          ...
                                          //echo '<td>'.$row['attendance'].'</td>';
                                            ...
                                            <?php
                                            echo '<td><a href="editStudentsAttendance.php?id=' . $row['id'] . '" class="btn btn-primary btn-sm" data-target="#modal_edit_user_5">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var printhead = party_var!=''?'<p><b>Classwise: </b>'+party_var+'</p>':'';
    ...
    function get_po_reports(){
        ...
        location.href="listStudentsAttendance.php?st="+st+"&end="+end+"&partywise="+partywise;
