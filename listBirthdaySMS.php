                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="number"  rows="5" placeholder="Type message here"></textarea>
                                                ...
                                                <div class="modal-footer-center">
													...
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<button type="button" name="submitgroup" id="submitgroup" class="btn btn-success">Get SMS Form</button>
						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left">Birth day Student List</h1>
													<ol class="breadcrumb float-right">
														<li class="breadcrumb-item">Home</li>
														<li class="breadcrumb-item active">Birth day Student List</li>
													</ol>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								<div class="card-header">
									...
									<i class="" aria-hidden="">Birth Day Students List</i>
								</div>
									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<tbody>
											<?php
													...
													fathername,mobile,academic,status FROM `studentprofile`WHERE status = 'Y' AND dob = CURRENT_DATE()";
