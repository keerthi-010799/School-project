	...
	<div class="row h-100 justify-content-center align-items-center">
		...
		<div class="card">
			...
			<div class="card-body">
                        ...
                        <form data-toggle="validator" role="form" method="post" action="reset-password2.php">
                                
								<div class="row">	
									<div class="col-md-12">    
									<div class="form-group">										
										<p><font color="maroon">How would you like to reset your Password?</font></p> 
									<div class="input-group">
									  <div class="input-group-prepend">
										<span class="input-group-text" id="basic-addon1"><i class="fa fa-envelope-open-o" aria-hidden="true"></i></span>
										</div>
									  <input type="email" class="form-control" name="email" placeholder="sa....e@g..." data-error="Input valid email" >								  
									</div>								
