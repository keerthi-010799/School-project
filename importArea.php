			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left"><i class="fa fa-upload bigfonts" aria-hidden="true"></i> Areanames Bulk Upload</h1>
                                    <ol class="breadcrumb float-right">
										<li class="breadcrumb-item">Home</li>
										<li class="breadcrumb-item active">Area Bulk Upload</li>
                                    </ol>
