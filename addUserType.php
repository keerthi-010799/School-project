			...
			<div class="container-fluid">
					...
					<div class="col-xl-12">
							<div class="breadcrumb-holder">
                                    <h1 class="main-title float-left">User Type Master</h1>
                                    <ol class="breadcrumb float-right">
									<a  href="index.php"><li class="breadcrumb-item">Home</a></li>
										<li class="breadcrumb-item active">User Type Master</li>
                                    </ol>
                                    <div class="clearfix"></div>
                            </div>
					</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">						
						<div class="card mb-3">
							<div class="card-header">
								...
								</i>&nbsp;User Type Master<span class="text-muted"></span></div></h3>
								...
								style="display: none; width: 0px; height: 0px;"></button-->
										...
										<div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select id="locname" onchange="oncompcode(this);" class="form-control" name="compcode">
                                                    ...
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here
                                                    $sql = mysqli_query($dbcon,"select concat(prefix,substr(cType,1,4),postfix,id) as code,name from comptypecode");
                                                      while ($row = $sql->fetch_assoc()){	
                                                        echo $compcode=$row['code'];
                                                        if($compcode==$_GET['compcode']){
                                                                echo '<option value="'.$compcode.'"  selected>'.$compcode.'</option>';  
                                                        }else{
                                                ...
                                                <script>
                                                    ...
                                                    {    
                                                        ...
                                                        window.location.href = 'addUserType.php?compcode='+compcode;
										...
										<div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label ><span class="text-danger">Company Type:&nbsp;</span> <?php if (isset($_GET["compcode"])) {

                                                    $comp_code = $_GET["compcode"];
                                        $sql = mysqli_query($dbcon,"select concat(prefix,substr(cType,1,4),postfix,id) as code,cType from comptypecode");
											while ($row = $sql->fetch_assoc()){	
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label ><span class="text-danger">Name:&nbsp</span> <?php if (isset($_GET["compcode"])) {

                                                    $comp_code = $_GET["compcode"];
                                                $sql = mysqli_query($dbcon,"select concat(prefix,substr(cType,1,4),postfix,id) as code,concat(title,name) as name,cType from comptypecode");
											while ($row = $sql->fetch_assoc()){	
                                                if($comp_code==$row['code']){
                                                    echo $row['name'];
                                                }
										  ...
										  <div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label ><span class="text-danger">Location:&nbsp</span> <?php if (isset($_GET["compcode"])) {
                                                $comp_code = $_GET["compcode"];
                                                $sql = mysqli_query($dbcon,"select concat(prefix,substr(cType,1,4),postfix,id) as code,concat(title,name) as name,cType,location from comptypecode");
											while ($row = $sql->fetch_assoc()){	
                                                if($comp_code==$row['code']){
                                                    echo $row['location'];
                                                }
									...
									<div class="form-group col-md-8">
									  ...
									  <input type="text" class="form-control" name="name" placeholder="User Full Name" required class="form-control" autocomplete="off">
									</div>
									</div>
