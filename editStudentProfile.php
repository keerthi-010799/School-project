							...
							<div class="card-body">
								...
								<?php
                                        ...
                                        if(isset($_GET['id']))
                                        {
                                            ...
                                            $result = mysqli_query($dbcon, "SELECT academic,admissionno,firstname,lastname,gender,dob,doa,batch,discount,category,oldschoolname,
                                            class,section,bloodgroup,nationality,religion,community,caste,fathername,mothername,
                                ...
                                <div class="form-row">
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="oldschoolname" value="<?php echo $oldschoolname;?>" />
                                    </div>                                    
                                </div>
                               <div class="form-row">
                                ...
                                <div class="form-row">                                
                                    <h5 class="col-md-12 text-muted text-info">Edit Discount&nbsp;</h5>
                                </div>

                                <div class="form-row">
								<div class="form-group col-md-12">
								<div class="checkbox"><label> Unassign Discount</label>&nbsp;&nbsp;
									Assign Discount <input type="radio" name="discount" value="Y"  <?php echo ($discount=='Y')?"checked":"";?> />	
									&nbsp;&nbsp;Unassign Discount <input type="radio" name="discount" value="N"  <?php echo ($discount=='N')?"checked":"";?> />
								</div>
								 </div>
                                 <label for="inputState">Category<span class="text-danger"></span></label>
                                                <select  id="areaname" onchange="onlocode(this)" 
