						...
						<div class="row">
									<div class="col-xl-12">
											<div class="breadcrumb-holder">
													<h1 class="main-title float-left">List Discount Students</h1>
													<ol class="breadcrumb float-right">
														<li class="breadcrumb-item">Home</li>
														<li class="breadcrumb-item active">List Discount Students</li>
													</ol>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
							<div class="card mb-3">
								<div class="card-header">
										...
										<a href="editStudentProfile.php" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
										Assign Student Discount</a></span>
								...
								<input type="submit" class="btn btn-primary btn-sm"  name="exportStudents" value="Export Bus Students"/>
                                    ...
                                    <div class="form-group col-md-3">
                                         ...
                                         <select id="classwise"   class="form-control form-control-sm"  name="class">
                                             <option value="">-Select class-</option>
                                                    <?php 
                                                    include("database/db_conection.php");//make connection here

                                                    $sql = mysqli_query($dbcon, "SELECT distinct class FROM class order by id asc");
